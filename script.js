...
function initToLocalSotage() {
    ...
    myForm.dispatchEvent(new CustomEvent('topicsUpdated'));
    // storeFromLocalStorage(topics);
}
...
`;
    // add to the DOM
    myForm.insertAdjacentHTML('beforeend', html);
...
function handleVotesIncreament() {
...
displayTopics(topics);
fetchTopics();
nextTopicContainer.addEventListener('topicsUpdated', initToLocalSotage);
